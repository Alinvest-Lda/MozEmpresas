    ...
    <>
      ...
      <section className="home-search-hero">
        <div className="container">
          ...
          <form action="/empresas" className="market-search market-search-main">
            ...
            <div className="search-field location-field"><span className="search-symbol" aria-hidden="true">⌖</span><input name="location" placeholder="Província ou localização" aria-label="Província ou localização" /></div>
            <button className="btn primary search-button">Pesquisar</button>
          </form>
          <div className="popular-searches"><span>Pesquisas populares</span><Link href="/empresas?q=construção">Construção</Link><Link href="/empresas?q=contabilidade">Contabilidade</Link><Link href="/empresas?q=tecnologia">Tecnologia</Link><Link href="/empresas?q=logística">Logística</Link><Link href="/empresas?q=consultoria">Consultoria</Link></div>
        </div>
      </section>
      ...
      <section className="section home-section section-soft"><div className="container">
        ...
        <div className="market-discovery"><div className="market-discovery-image"><img src="https://central.bvm.co.mz/storage/app/public/files/notice/140/_MG_8266.JPG" alt="Profissionais negros numa reunião empresarial em Moçambique" loading="lazy" /><div className="image-tag">Mercado empresarial</div></div><div className="discovery-steps">
          ...
          <Link href="/oportunidades" className="discovery-step"><span>03</span><div><strong>Faça negócio</strong><p>Consulte concursos, necessidades e oportunidades de parceria.</p></div><b>→</b></Link>
        </div></div>
      </div></section>
      <section className="section home-section"><div className="container">
